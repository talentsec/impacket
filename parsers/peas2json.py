...
def clean_colors(line: str) -> str:
    ...
    #line = re.sub(r"\\u\d\d\S\S\[\d;\S\Sm\s*","",line)
    #line = re.sub(r"\\u\d\d\S\S\[\dm","",line)
    #line = re.sub("\uSS/S/S/S","",line)
    #line = re.sub("\s{3,}","",line)
    # ret = re.search(r'\\u\S{4}',line)
    # if ret:
    #     print(line)
...
if __name__ == "__main__":
    ...
    try:
        ...
        sys.exit(1)
    #OUTPUT_PATH = 'D:\disk\win7disk\parsers\winPEAS.txt' 
    #JSON_PATH = 'D:\disk\win7disk\parsers\winPEAS.json'
